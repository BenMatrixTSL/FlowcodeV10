// CRC: 
// REVISION: 10.0
...
MX_SINT16 FCI_COMPARE(MX_STRING sSrc1, MX_UINT16 iSrc1_len, MX_STRING sSrc2, MX_UINT16 iSrc2_len, MX_UINT8 iNoCase);
...
MX_FLOAT FCI_STRING_TO_FLOAT(MX_STRING String, MX_UINT16 MSZ_String)
{
  MX_UINT8 idx = 0;
  MX_UINT8 bNegative = 0;
  MX_UINT32 iPostDotDiv = 0;  //zero means still processing the whole part before the dot
  MX_UINT32 iWholePart = 0;
  MX_UINT32 iFractPart = 0;
  MX_FLOAT fRetVal = 0.0;
  ...
  //While string contains a valid number
  while ((idx < MSZ_String) && (((String[idx] >= '0') && (String[idx] <= '9')) || ((String[idx] == '.') && (iPostDotDiv == 0))))
  {
    if (String[idx] == '.')
    {
      iPostDotDiv = 1;
    }
    else if (iPostDotDiv == 0)
    {
      //still before the decimal point
      iWholePart = (long)(iWholePart * 10);
      iWholePart = (long)(iWholePart + (String[idx] - '0'));
    }
    else
    {
      iPostDotDiv = iPostDotDiv * 10;
      iFractPart = (long)(iFractPart * 10);
      iFractPart = (long)(iFractPart + (String[idx] - '0'));
    }
    idx = idx + 1;
  }

  //create the fractional part of the return value
  if (iFractPart > 0)
  {
    fRetVal = (MX_FLOAT)iFractPart / (MX_FLOAT)iPostDotDiv;
  }

  //add the whole part tot he return value
  fRetVal = fRetVal + (MX_FLOAT)(iWholePart);
